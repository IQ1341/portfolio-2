...
(function () {
  ...
  ═════════════════════════════════════════════ */
  const PHOTOS = [
    { src: 'assets/img/prj1.JPEG', title: 'Project HG Kepulaun Riau',             caption: 'Implementasi Smart Farming Batam & Natuna',      cat: 'project', size: 'h-wide'   },
    { src: 'assets/img/prj5.JPEG', title: 'Project HG Sulawesi Barat',           caption: 'Implementasi Smart Farming Majene',     cat: 'project', size: 'h-wide'   },
    { src: 'assets/img/prj6.JPEG', title: 'Project HG Papua Selatan',         caption: 'Implementasi Smart Farming Merauke',             cat: 'project',   size: 'h-wide'   },
    { src: 'assets/img/prj4.JPEG', title: 'Project HG Riau',         caption: 'Implementasi Smart Farming Pekanbaru',             cat: 'project',   size: 'h-wide'   },
    { src: 'assets/img/prj3.JPEG', title: 'Project HG DKI Jakarta',             caption: 'Implementasi Smart Farming Jakarta',   cat: 'project',   size: 'h-wide' },
    { src: 'assets/img/prj2.JPEG', title: 'Project HG Jawa Tengah',    caption: 'Implementasi Smart Farming',    cat: 'project',  size: 'h-wide'   },
    { src: 'assets/img/hg1.jpeg', title: 'Full Team Habibi Garden',          caption: 'Building solutions under pressure',     cat: 'hg',  size: 'h-wide' },
    { src: 'assets/img/hg2.jpeg', title: 'Full Team Habibi Garden',       caption: 'Installing MQTT sensors on field',      cat: 'hg',   size: 'h-sm'   },
    { src: 'assets/img/hg3.jpeg', title: 'Team Software HG',           caption: 'My daily ritual before shipping',       cat: 'hg',   size: 'h-sq'   },
    { src: 'assets/img/hg4.jpeg', title: 'Habibi Garden',          caption: 'Real-time monitoring system online',    cat: 'hg',    size: 'h-md'   },
    { src: 'assets/img/hg5.jpeg', title: 'Habibi Garden',         caption: 'Presenting IoT project to judges',      cat: 'hg',  size: 'h-lg'   },
    { src: 'assets/img/hg6.JPEG', title: 'Habibi Garden',      caption: 'Whiteboarding backend architecture',    cat: 'hg', size: 'h-wide' },
    { src: 'assets/img/pmm4.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm5.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm1.jpeg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm7.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm2.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm3.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pmm6.jpg', title: 'Student Exchange',            caption: 'Setting up sensor nodes for farm',      cat: 'pmm',    size: 'h-wide'   },
    { src: 'assets/img/pkm3.jpg', title: 'Full Team PKM',        caption: 'Late night debugging session',          cat: 'pkm', size: 'h-lg'   },
    { src: 'assets/img/pkm1.jpeg', title: 'Full Team PKM',        caption: 'Late night debugging session',          cat: 'pkm', size: 'h-wide'   },
    { src: 'assets/img/pkm2.jpeg', title: 'Full Team PKM',        caption: 'Late night debugging session',          cat: 'pkm', size: 'h-lg'   },
    { src: 'assets/img/pkm4.jpg', title: 'Full Team PKM',        caption: 'Late night debugging session',          cat: 'pkm', size: 'h-wide'   },
  ];
